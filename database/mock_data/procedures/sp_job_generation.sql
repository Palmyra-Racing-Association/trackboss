CREATE DEFINER=`dev`@`localhost` PROCEDURE `sp_event_job_generation`(
IN _event_date DATE, 
...
BEGIN
    ...
    getEventJob: LOOP
        ...
        SELECT job_day_number INTO @JobDayNumber FROM job_type WHERE job_type_id = cur_job_type; 
        
        SET sqlDOW = (@JobDayNumber + 1) % 7; 
